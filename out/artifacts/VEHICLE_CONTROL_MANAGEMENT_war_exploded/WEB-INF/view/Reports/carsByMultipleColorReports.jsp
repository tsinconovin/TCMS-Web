...
<section class="content-header">
    <h6>
        <ol class="breadcrumb bc6">
            <li>گزارش خودروها بر اساس چندین رنگ</li>
        </ol>
    </h6>
    <br>
</section>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="form-group">
                                <div class="col-lg-4 col-md-2" style="">
                                    <label>لطفا رنگـ های مورد نظر خود را انتخاب کنید.</label>
                                    <div class="form-group">
                                        <select class="form-control" id="colorId" name="colorName" multiple>
