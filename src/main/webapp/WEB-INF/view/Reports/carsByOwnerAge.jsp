...
<section class="content-header">
    <h6>
        <ol class="breadcrumb bc6">
            <li>گزارش ها</li>
            <li>گزارش خودروها بر اساس سن<span class="c5"> | گزارش ویژه  </span></li>
        </ol>
    </h6>
    <br>
</section>
...
<%--                    </div>--%>
                    <div class="box box-details">
                        <div class="box-header with-border">
                            <h3 class="box-title c1"> فهرست خودرو ها مالکان بالای 70 سال</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="scrol_table" class="table-responsive no-padding" style="height: 400px">
                                        ...
                                        <table class="table table-hover table-striped table-bordered sticky font--bold font_scale--normal"
                                            ...
                                            <% int c = 1;%>
                                            <c:forEach items="${ownerCarO70List}" var="ownerCarO70List">
                                            <tr id="">
                                                <td class="sticky-r"><%= c %>
                                                </td>
                                                <td>${ownerCarO70List.getOwner_id()}</td>
                                                <td>${ownerCarO70List.getType()}</td>
                                                <td>${ownerCarO70List.getColor()}</td>
                                                <td>${ownerCarO70List.getLength()}</td>
                                                <td>${ownerCarO70List.getLoad_valume()}</td>
                                                <td>${ownerCarO70List.getDelete_flag()}</td>
